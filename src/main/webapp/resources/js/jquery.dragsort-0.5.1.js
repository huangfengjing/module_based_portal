		...
		this.each(function(i, cont) {
			...
			var newList = {
				...
				grabItem: function(e) {
                    ...
                    // 取消点击事件
                    $(list.container).click(function() {return false;});
				...
				dragStart: function(e) {
                    ...
                    // 尺寸减 2 以适应 1px 的边框增长
					var h = list.draggedItem.height() - 2;
					var w = list.draggedItem.width() - 2;
					if (opts.itemSelector == "tr") {
						list.draggedItem.children().each(function() { $(this).width($(this).width()); });
						list.placeHolderItem = list.draggedItem.clone().attr("data-placeholder", true);
						list.draggedItem.after(list.placeHolderItem);
						list.placeHolderItem.children().each(function() { $(this).css({ borderWidth:0, width: $(this).width() - 2, height: $(this).height() - 2 }).html("&nbsp;"); });
					} else {
				...
				createDropTargets: function() {
					...
					$(lists).each(function() {
                        ...
                        // 动态修改占位符的宽度
                        ph.width($(this.container).width() - 2);
					});
				}
			};
